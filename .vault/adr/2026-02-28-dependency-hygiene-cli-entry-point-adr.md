...
# `dependency-hygiene-cli-entry-point` adr: `adr-13` | (**status:** `accepted`)
...
- Original ADR number: `ADR-13`
- Original title: `Dependency Hygiene, Pruning, OTel Mandate & CLI Entry Point`
