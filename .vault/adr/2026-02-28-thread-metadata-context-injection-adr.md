...
# `thread-metadata-context-injection` adr: `adr-12` | (**status:** `proposed`)
...
- Original ADR number: `ADR-12`
- Original title: `Thread Metadata & Context Injection`
