...
# `blackboard-content-mounting` adr: `adr-16` | (**status:** `implemented`)
...
- Original ADR number: `ADR-16`
- Original title: `Blackboard Content Mounting`
...
- ADR-014 — workspace_root threading pattern
- ADR-019 — vault_index, reference-in-state principle
- ADR-022 — anchoring summary, message positions 2 and 3
- legacy-research/2026-03-03-content-mounting-derisking.md — token ceiling, async I/O, mount step pattern
