...
- Original ADR number: `ADR-18`
- Original title: `Contextual Anchoring in Graph Lifecycle`
...
- ADR-013 --- Team Composition (supervisor routing, `state["next"]`)
- ADR-014 --- Thread Metadata (context preamble, message ordering)
- ADR-019 --- TeamState enrichment (active_feature, vault_index, validation_errors)
- arXiv 2507.01701 --- Blackboard control unit per-invocation state inspection
