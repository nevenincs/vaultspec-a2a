...
<!-- FRONTMATTER RULES:
     ...
     The S107 and 2026-07-18-desktop-product-profile-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add the production installed-inventory builder that consumes verified archive sessions applies the layout authority and emits canonical v2 inventory bytes into the content-addressed input cache invoked by the capsule build script and ## Scope
