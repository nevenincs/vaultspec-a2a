...
<!-- FRONTMATTER RULES:
     ...
     The S14 and 2026-07-18-desktop-product-profile-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Verify capsule identity target closure entrypoints digests licenses and software bill of materials without a source checkout and ## Scope

- `scripts/verify_desktop_capsule.py` placeholders below are machine-filled
