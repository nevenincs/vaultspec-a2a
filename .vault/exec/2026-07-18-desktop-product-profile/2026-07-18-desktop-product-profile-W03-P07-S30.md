...
<!-- FRONTMATTER RULES:
     ...
     The S30 and 2026-07-18-desktop-product-profile-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Implement the cross-platform lifetime singleton and owner-matching stale-lock classification for one desktop app home and ## Scope

- `src/vaultspec_a2a/lifecycle/singleton.py` placeholders below are machine-filled
