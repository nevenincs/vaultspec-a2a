...
modified: '2026-08-02'
body_schema: 'body-v1'
body_hash: 'sha256:09a3fdf9ff58b69ca8c00f72b07d333bcc765c619fcd03c1c103929707d1e87a'
step_id: 'S60'
related:
...
<!-- FRONTMATTER RULES:
     ...
     The S60 and 2026-08-02-provider-error-taxonomy-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Refuse a retry once the lane has already relayed output and ## Scope

- `src/vaultspec_a2a/graph/nodes/worker.py` placeholders below are machine-filled
