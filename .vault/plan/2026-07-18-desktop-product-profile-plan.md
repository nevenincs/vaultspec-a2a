...
- [ ] `W01.P03.S106` - Extend the installed inventory to version two with per-file source_sha256 and source_member provenance proving every pair names a verified closure member and migrate all fixtures to real provenance; `src/vaultspec_a2a/desktop/installed_inventory.py, src/vaultspec_a2a/desktop/tests/test_installed_inventory.py`.
