...
- [ ] `W01.P03.S117` - Change the layout authority to drop wheel data headers and data scripts members deterministically with per-member evidence instead of rejecting them keeping data data platinclude and unknown keys fail-closed so the real closure materializes; `src/vaultspec_a2a/desktop/install_layout.py, src/vaultspec_a2a/desktop/tests/test_install_layout.py`.
