...
- [ ] `W01.P03.S100` - Consolidate package and capsule archive scanning behind shared bounded member path collision expansion-ratio central-directory and retained-snapshot authorities before extraction; `src/vaultspec_a2a/desktop/package_archives.py, src/vaultspec_a2a/desktop/_capsule_archive_io.py, src/vaultspec_a2a/desktop/tests/test_package_archives.py, src/vaultspec_a2a/desktop/tests/test_capsule_archives.py`.
