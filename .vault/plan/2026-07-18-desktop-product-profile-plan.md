...
- [ ] `W01.P03.S116` - Derive per-package license identity from wheel metadata and tarball contents author the committed curated overrides input with expression entries and external license artifacts and emit the canonical closure inventories; `src/vaultspec_a2a/desktop/capsule_input_authoring.py, scripts/desktop_capsule_inputs.toml, src/vaultspec_a2a/desktop/tests/test_capsule_license_derivation.py`.
