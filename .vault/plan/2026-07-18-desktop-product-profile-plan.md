...
- [ ] `W01.P03.S118` - Resolve the ACP license contract gap with a curated override path for non-SPDX SEE-LICENSE-IN references binding the referenced license file then derive ACP package license identity and emit the canonical ACP closure inventory; `src/vaultspec_a2a/desktop/closure_inventory.py, src/vaultspec_a2a/desktop/package_archives.py, src/vaultspec_a2a/desktop/capsule_input_authoring.py, scripts/desktop_capsule_inputs.toml`.
