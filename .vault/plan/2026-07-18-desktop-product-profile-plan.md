...
- [ ] `W01.P03.S112` - Reserve and place the donated launcher stub license notice inside the capsule so the redistribution terms ship with the product launchers; `src/vaultspec_a2a/desktop/capsule_assembly.py, src/vaultspec_a2a/desktop/capsule_materializer.py, src/vaultspec_a2a/desktop/tests/test_capsule_materializer.py`.
