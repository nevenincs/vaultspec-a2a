...
- [x] `W01.P05.S33` - Record a durable reason when a clarification resume is not delivered; `src/vaultspec_a2a/control/clarification_service.py`.
...
- [x] `W01.P05.S59` - Drain the worker failure stash even when the settle path dies; `src/vaultspec_a2a/worker/executor.py`.
