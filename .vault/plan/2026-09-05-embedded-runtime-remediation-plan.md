...
modified: '2026-09-06'
body_schema: body-v2
body_hash: 'sha256:b24c83cf24acca98f2e2c754285d62e4affc3a82da271bef17ea8a317d81f380'
---
...
- [ ] `W02.P03.S85` - Correct condition 17 at its process-lifecycle root: give verification one bounded owner that closes resource-aware plugin sessions, database engines, transports, subprocesses and machine-global leases, then require natural process exit or a classified cleanup failure with zero survivors; `src/vaultspec_a2a/testing, src/vaultspec_a2a/tests`.
