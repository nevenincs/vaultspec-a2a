...
modified: '2026-09-05'
body_schema: body-v2
body_hash: 'sha256:ae0160db93cabb43541ff8b0565d878fcd52f7366627c7e888b901f8f727feb9'
---
...
- [ ] `W01.P01.S01` - Record the intended A2A commit/binary identity, Dashboard generation, A01-A34 applicability, supported-mode inventory and pre-test queue/deadline/host limits without changing the frozen acceptance thresholds; `qualification evidence`.
...
- [ ] `W01.P02.S04` - Run PostgreSQL URL checks under the locked server dependency profile and make that profile explicit while preserving the SQLite binary profile; `pyproject.toml`.
...
- [ ] `W04.P10.S47` - Conform readiness/drain/shutdown routes and ownership capability handling to the intended consumer generation with fail-closed incompatible attachment; `src/vaultspec_a2a/api/routes/admin.py`.
...
- [ ] `W04.P10.S50` - Upgrade release lifecycle qualification to execute the actual frozen worker and positive module/MCP paths through the intended Dashboard launch; `scripts/prove_artifact_lifecycle.sh`.
