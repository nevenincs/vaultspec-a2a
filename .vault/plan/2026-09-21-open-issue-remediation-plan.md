...
modified: '2026-09-21'
body_schema: body-v2
body_hash: 'sha256:c275284b797c7b891b48f3e479cb24fc4058cd38e31d5b39fc1b8137f4a272fb'
---
...
- [x] `P01.S04` - Re-scope issue #26 to the Dashboard-owned release-set contract and implement only the missing A2A version and changelog preparation guarantees; `.github/workflows/release.yml, pyproject.toml, CHANGELOG.md, scripts/, GitHub issue #26`.
