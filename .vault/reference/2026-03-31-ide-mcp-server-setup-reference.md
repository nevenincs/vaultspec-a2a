...
# `ide-mcp-setup` reference: `workspace-configurations`

This reference was migrated from the removed legacy documentation tree so the IDE and MCP setup instructions remain discoverable inside the vault.
