...
- [LangGraph Persistence Guide](https://fast.io/resources/langgraph-persistence/) --- reference-in-state pattern
- [Google ADK Architecture](https://raphaelmansuy.github.io/adk_training/blog/2025/12/08/context-engineering-google-adk-architecture/) --- artifact handle pattern
- [arXiv 2507.01701](https://arxiv.org/abs/2507.01701) --- blackboard phase gate / stopping condition
- [MetaGPT arXiv 2308.00352](https://arxiv.org/html/2308.00352v6) --- validation quality gate
