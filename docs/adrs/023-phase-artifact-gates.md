...
- [ADR-019](019-teamstate-enrichment-sdd-blackboard.md) — `vault_index` structure and update contract
- [ADR-022](022-contextual-anchoring-graph-lifecycle.md) — existing `validation_errors` FINISH gate pattern
