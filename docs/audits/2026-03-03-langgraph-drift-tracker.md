...
**Updated:** 2026-03-03
**Scope:** Ongoing audit of `lib/core/` modules against official LangGraph documentation.
...
- **Module:** `lib/core/nodes/supervisor.py`
- **ADR:** ADR-024
- **Status:** Redesign Required
...
- **Module:** `lib/core/nodes/supervisor.py`, `lib/core/nodes/worker.py`
- **ADR:** ADR-022
- **Status:** Fix Required
...
- **Module:** `lib/core/nodes/worker.py`
- **ADR:** ADR-021
