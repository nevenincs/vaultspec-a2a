...
| DB-008 | LOW | OPEN | update_thread missing from crud.__all__ |
| DB-009 | LOW | OPEN | get_thread missing from crud.__all__ |
...
- **DB-008** (update_thread in crud.__all__): **RESOLVED** — now at line 58 of crud.py `__all__`
- **DB-009** (get_thread in crud.__all__): **STILL OPEN** — not in crud.py `__all__`
