...
**URL**: `https://www.figma.com/make/EAs7Eh1lxKVzBqzke5HASU/VaultSpec-A2A-Control-Surface`

---

## Source Files

Full list of MCP resources available via `file://figma/make/source/EAs7Eh1lxKVzBqzke5HASU/{path}`.
