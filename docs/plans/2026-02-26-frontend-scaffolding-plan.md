...
Since the OpenAPI endpoint isn't implemented yet, manually write TypeScript types
matching all Pydantic models. These will later be replaced by `openapi-typescript`
generated output.
...
- `respondToPermission(requestId: string, req: PermissionResponseRequest): Promise<PermissionResponseResult>`
