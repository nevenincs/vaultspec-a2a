...
- `context_refs` in the preamble tell agents documents _exist_ but do not read and inject the file content. The research mandate requires content injection (see Gap 2 below).
