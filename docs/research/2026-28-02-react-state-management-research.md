...
- [TanStack Query + WebSockets (tkdodo)](https://tkdodo.eu/blog/using-web-sockets-with-react-query)
- [Zustand + TanStack Query Pattern](https://javascript.plainenglish.io/zustand-and-tanstack-query-the-dynamic-duo-that-simplified-my-react-state-management-e71b924efb90)
- [React State Management 2026 Comparison](https://dev.to/jsgurujobs/state-management-in-2026-zustand-vs-jotai-vs-redux-toolkit-vs-signals-2gge)
