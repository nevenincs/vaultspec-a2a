...
class TestBuildContextPreamble:
    ...
    def test_returns_system_message(self, tmp_path: Path) -> None:
    ...
    def test_minimal_preamble_workspace_only(self, tmp_path: Path) -> None:
    ...
    def test_includes_feature_tag(self, tmp_path: Path) -> None:
    ...
    def test_includes_source_repo(self, tmp_path: Path) -> None:
    ...
    def test_includes_source_branch(self, tmp_path: Path) -> None:
    ...
    def test_full_preamble_all_fields(self, tmp_path: Path) -> None:
    ...
    def test_context_refs_without_summary(self, tmp_path: Path) -> None:
    ...
    def test_no_optional_fields_no_extra_lines(self, tmp_path: Path) -> None:
