...
def _authoring_binding(
    *, engine_base_url: str = "http://127.0.0.1:8767", run_id: str = "run:codex-test"
    ...
    """A real stdio-transport binding, matching production's ``AuthoringBindingProvider``."""
...
def test_attach_authoring_tools_refuses_a_provider_with_no_attachment_surface() -> (
    None
):
